...
//AUTHOR: John Stewart
//FILENAME: Lab2.java
//SPECIFICATION: Takes the users first and last name and produces an upper case output and 
 * the length of said name. It also compares two different methods of comparing strings' data.
 */
//FOR: CS 1400 - Lab #2
